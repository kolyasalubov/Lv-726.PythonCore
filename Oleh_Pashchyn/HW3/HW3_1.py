...
print(f"Number of word 'better': {philosophy.count('better')}",
      f"Number of word 'never': {philosophy.count('never')}",
      f"Number of word 'is': {philosophy.count('is')}",
      sep='\n')

print(f"{philosophy.upper()}")

print(f"{philosophy.replace('i', '&')}")