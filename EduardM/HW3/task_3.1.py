...
print(f"Number of 'better': {philosophy.count('better')}\n"
      f"Number of 'never': {philosophy.count('never')}\n"
      f"Number of 'is': {philosophy.count('is')}")
print(f"\n{philosophy.upper()}\n")
print(f"\v{philosophy.replace('i', '&')}")
