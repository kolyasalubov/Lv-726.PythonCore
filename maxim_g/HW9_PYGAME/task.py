...
while run:
    ...
    if keys[pygame.K_LEFT] and outside_rule[0]:
        COORD_X = COORD_X - DELTA_STEP
    if keys[pygame.K_RIGHT] and outside_rule[2]:
        COORD_X = COORD_X + DELTA_STEP
    if keys[pygame.K_UP] and outside_rule[1]:
        COORD_Y = COORD_Y - DELTA_STEP
    if keys[pygame.K_DOWN] and outside_rule[3]:
        COORD_Y = COORD_Y + DELTA_STEP
