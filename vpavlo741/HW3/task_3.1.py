...
#Пошук слів
count_1 = py_philosophy.count('better')
print(count_1)
count_2 = py_philosophy.count('is')
print(count_2)
count_3 = py_philosophy.count('never')
print(count_3)
#Верхній регістр
UPPERCASE = py_philosophy.upper()
print(UPPERCASE)

#Заміна символів
replacing = py_philosophy.replace('i', '&')
print(replacing)